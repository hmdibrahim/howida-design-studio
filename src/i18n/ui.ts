  ...
  en: {
    ...
    home: {
      ...
      portfolio: {
        ...
        subtitle: 'A look at completed projects across the spaces we design and deliver.',
        items: [
          { category: 'Living Rooms' },
          { category: 'Majlis' },
          { category: 'Bedrooms' },
          { category: 'Restaurants' },
          { category: 'Toilets & Powder Rooms' },
  ...
  ar: {
    ...
    home: {
      ...
      portfolio: {
        ...
        subtitle: 'نظرة على مشاريع منجزة في مختلف المساحات التي نصممها وننفذها.',
        items: [
          { category: 'غرف المعيشة' },
          { category: 'المجالس' },
          { category: 'غرف النوم' },
          { category: 'المطاعم' },
          { category: 'دورات المياه' },
          { category: 'أعمال النجارة والتشطيب' },
          { category: 'تصميم الأثاث' },
        ],
        cta: 'تصفّح خدماتنا',
      },
